...
class GcpDeltaFileRecordChangeNotifier : public DeltaFileRecordChangeNotifier {
 public:
  explicit GcpDeltaFileRecordChangeNotifier(
...
DeltaFileRecordChangeNotifier::Create(
  ...
  return std::make_unique<GcpDeltaFileRecordChangeNotifier>(
