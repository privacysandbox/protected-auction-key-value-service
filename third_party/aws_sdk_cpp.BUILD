...
cc_library(
    name = "ec2",
    srcs = glob([
        "aws-cpp-sdk-ec2/source/*.cpp",  # AWS_EC2_SOURCE
        "aws-cpp-sdk-ec2/source/model/*.cpp",  # AWS_EC2_MODEL_SOURCE
    ]),
    hdrs = glob([
        "aws-cpp-sdk-ec2/include/aws/ec2/*.h",  # AWS_EC2_HEADERS
        "aws-cpp-sdk-ec2/include/aws/ec2/model/*.h",  # AWS_EC2_MODEL_HEADERS
    ]),
    includes = [
...
cc_library(
    name = "sqs",
    srcs = glob([
        "aws-cpp-sdk-sqs/source/*.cpp",  # AWS_SQS_SOURCE
        "aws-cpp-sdk-sqs/source/model/*.cpp",  # AWS_SQS_MODEL_SOURCE
    ]),
    hdrs = glob([
        "aws-cpp-sdk-sqs/include/aws/sqs/*.h",  # AWS_SQS_HEADERS
        "aws-cpp-sdk-sqs/include/aws/sqs/model/*.h",  # AWS_SQS_MODEL_HEADERS
    ]),
    includes = [
...
cc_library(
    name = "ssm",
    srcs = glob([
        "aws-cpp-sdk-ssm/source/*.cpp",  # AWS_SSM_SOURCE
        "aws-cpp-sdk-ssm/source/model/*.cpp",  # AWS_SSM_MODEL_SOURCE
    ]),
    hdrs = glob([
        "aws-cpp-sdk-ssm/include/aws/ssm/*.h",  # AWS_SSM_HEADERS
        "aws-cpp-sdk-ssm/include/aws/ssm/model/*.h",  # AWS_SSM_MODEL_HEADERS
    ]),
    includes = [
