...
#ifndef COMPONENTS_DATA_SERVER_REQUEST_HANDLER_COMPRESSION_H_
#define COMPONENTS_DATA_SERVER_REQUEST_HANDLER_COMPRESSION_H_
...
#endif  // COMPONENTS_DATA_SERVER_REQUEST_HANDLER_COMPRESSION_H_
